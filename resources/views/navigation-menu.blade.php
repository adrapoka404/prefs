    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('positions.index') }}" :active="request()->routeIs('positions.*')">
                        {{ __('Puestos') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin_blog.index') }}" :active="request()->routeIs('admin_blog.*')">
                        {{ __('Blog') }}
                    </x-jet-nav-link>
                </div>
            </div>
