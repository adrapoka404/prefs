                    ...
                    <div class="flex flex-col md:flex-row lg:inline mx-3 py-3">
                            ...
                            <div class="md:flex md:flex-col lg:flex-row w-full mx-5 my-3 md:w-1/2 lg:w-full capitalize  hover:shadow-lg rounded-lg border-2 lg:border-0">
                                ...
                                <div class="w-full flex lg:w-1/5 mx-3 lg:p-3">
                                    ...
                                    <div class="w-1/2 lg:w-full mx-">
                                        <a href="{{route('admin_roles.edit', $role->id)}}" class="cursor-pointer px-5 py-2 bg-blue-400 text-white hover:bg-blue-700 rounded-full font-semibold">
                                            Editar
                                        </a>
                                                {!! Form::open(['url'=> route('admin_roles.destroy', $role->id)]) !!}
                                                    @method('delete')
                        ...
                        @else 
                            <div class="w-1/2 mx-auto">
                                Aún no hay elementos en la BD, crea un
                                <a href="{{route('admin_roles.create')}}" class="cursor-pointer text-blue-300 font-medium">
                                     nuevo Role
                                </a>
                            </div>
                        @endif
