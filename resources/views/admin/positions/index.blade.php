            ...
            <div class="bg-white ">
                ...
                <div class="flex flex-col">
                    ...
                    <div
                        ...
                        <div class="w-1/5">Descripción</div>
                    ...
                    <div class="flex flex-col md:flex-row lg:inline mx-3 py-3">
                            ...
                            ">
                                ...
                                <div class="w-full flex lg:w-1/5 mx-3 lg:p-3">
                                    ...
                                    <div class="w-1/2 lg:w-full mx-">
                                        <a href="{{route('positions.edit', $position->id)}}" class="cursor-pointer px-5 py-2 bg-blue-400 text-white hover:bg-blue-700 rounded-full font-semibold">
                                            Editar
                                        </a>
                                        @if ($position->status == 0)
                                                
                                                <a href="{{route('positions.show', $position->id)}}" class="cursor-pointer px-3 py-1 bg-orange-300 text-white hover:bg-orange-500 rounded-full font-semibold">
                                                    Activar
                                                </a>
                                            
                                        @else
                                                {!! Form::open(['url'=> route('positions.destroy', $position->id)]) !!}
                                                    @method('delete')
                        ...
                        @else 
                            <div class="w-1/2 mx-auto">
                                Aún no hay Puestos en la BD, crea un
                                <a href="{{route('positions.create')}}" class="cursor-pointer text-blue-300 font-medium">
                                     nuevo puesto
                                </a>
                            </div>
                        @endif
