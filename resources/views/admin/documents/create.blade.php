<x-app-layout>
    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 rounded-2xl">
            <div class="bg-white ">
                {!! Form::open(['url' => route('admin_documents.store'), 'id' => 'formCreate', 'autocomplete' => 'off','files' => true]) !!}
                ...
                <x-row-two>
                    ...
                    <x-slot name='input'>
                        <div class="flex flex-row text-center">
                            ...
                            <div class="w-1/2">
                                <x-link-cancel>
                                    <x-slot name='id'>btnCompaniesCancel</x-slot>
                                    <x-slot name='txt'>Cancelar</x-slot>
                                    <x-slot name='href'>{{ route('admin_documents.index') }}</x-slot>
                                </x-link-cancel>
                            </div>
